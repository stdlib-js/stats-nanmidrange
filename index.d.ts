...
interface Unary {
	...
	*/
	...
	/**
	* Computes the mid-range along one or more ndarray dimensions, ignoring `NaN` values, and assigns results to a provided output ndarray.
	*
	* @param x - input ndarray
...
* // returns true
*/
declare const nanmidrange: Unary;
